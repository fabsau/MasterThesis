...
def upgrade() -> None:
    ...
    sa.Column('incident_status', sa.Enum('unresolved', 'in_progress', 'resolved', name='incident_status_t'), nullable=True),
    ...
    sa.Column('threat_id', sa.BigInteger(), nullable=False),
    sa.Column('verdict', sa.Enum('false_positive', 'true_positive', 'unknown', name='analyst_verdict_t'), nullable=False),
